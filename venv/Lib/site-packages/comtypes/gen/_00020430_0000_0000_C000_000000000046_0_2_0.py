...
__all__ = [ 'OLE_XSIZE_PIXELS', 'FONTITALIC', 'IPicture',
           'OLE_XPOS_PIXELS', 'Unchecked', 'FONTUNDERSCORE',
           'OLE_YPOS_PIXELS', 'OLE_YSIZE_PIXELS', 'FONTBOLD',
           'FONTNAME', 'OLE_TRISTATE', 'FONTSIZE', 'IPictureDisp',
           'OLE_XSIZE_CONTAINER', 'OLE_XPOS_CONTAINER', 'Default',
           'OLE_XPOS_HIMETRIC', 'Monochrome', 'LoadPictureConstants',
           'OLE_YPOS_CONTAINER', 'OLE_YPOS_HIMETRIC', 'StdFont',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_XSIZE_HIMETRIC', 'Color',
           'OLE_YSIZE_CONTAINER', 'FONTSTRIKETHROUGH', 'OLE_HANDLE',
           'VgaColor', 'OLE_YSIZE_HIMETRIC', 'Gray', 'IFontDisp',
           'StdPicture', 'Font', 'IFont', 'OLE_COLOR',
           'OLE_CANCELBOOL', 'FontEvents', 'Checked', 'Picture',
